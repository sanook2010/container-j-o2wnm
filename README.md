...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j-o2wnm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j-o2wnm.containers.anotherwebservice.com/
...
```
git clone git@github.com:sanook2010/container-j-o2wnm.git
cd container-j-o2wnm
```
...
```
docker attach container-j-o2wnm
```
